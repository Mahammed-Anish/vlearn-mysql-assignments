...
(133,'b@a.com','Neha','Smith','ABC',1,0),
...
UPDATE CONTACT SET OPT_OUT=0 WHERE OPT_OUT=1;
...
-- 4) Insert a new row with id as 658, name as ‘mili’, email as ‘mili@gmail.com’, 
-- the company as ‘DGH’, active flag as 1, opt-out flag as 1
INSERT INTO CONTACT VALUES (658,'mili@gmail.com','mili','mili','DGH',1,1);
